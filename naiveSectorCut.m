...
%         O2 = shiftColor(hue_img,sectorCenter,w,sectorCenter,cut,hue_len,1);
        ...
        O1 = shiftColor(hue_img,sectorCenter,2*abs(sectorCenter - bound(1,1)),cut,sectorCenter,hue_len,-1);
        O2 = shiftColor(hue_img,sectorCenter,2*abs(sectorCenter - bound(2,1)),sectorCenter,cut,hue_len,1);
...
%         O22 = shiftColor(hue_img,sectorCenter2,w2,sectorCenter2,cut1,hue_len,1);% 2st sector
       ...
       O11 = shiftColor(hue_img,sectorCenter1,2*abs(sectorCenter1 - bound(1,1)),cut1,sectorCenter1,hue_len,-1);% 1st sector
       O21 = shiftColor(hue_img,sectorCenter1,2*abs(sectorCenter1 - bound(2,1)),sectorCenter1,cut2,hue_len,1);% 1st sector
       O12 = shiftColor(hue_img,sectorCenter2,2*abs(sectorCenter2 - bound(1,2)),cut2,sectorCenter2,hue_len,-1);% 2st sector
       O22 = shiftColor(hue_img,sectorCenter2,2*abs(sectorCenter2 - bound(2,2)),sectorCenter2,cut1,hue_len,1);% 2st sector
